...
export default observer(() => {
    ...
    const [ classForm, setClassForm ] = useState(styles.form);
    const location = useLocation();

    useEffect(() => {
        if(location.pathname == "/login/create") {
            setBackground("/src/pages/login/signup.png");
            setClassForm(styles.reg_form);
        } else if(location.pathname == "/login/reset") {
            setBackground("/src/pages/login/reset1.png");
            setClassForm(styles.reset_form);
        } else {
            setBackground("/src/pages/login/login.png");
            setClassForm(styles.form);
        }
    });
